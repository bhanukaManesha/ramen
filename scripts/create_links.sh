...
cd ${PROJECT_ROOT}/dataset/CLEVR_CoGenTB/glove
ln -s ../../glove/glove.6B.300d.txt glove.6B.300d.txt


# CLEVR_Human
cd ${PROJECT_ROOT}/dataset/CLEVR_Human/features
...
cd ${PROJECT_ROOT}/dataset/CLEVR_Human/glove
ln -s ../../glove/glove.6B.300d.txt glove.6B.300d.txt

# VQA
cd ${PROJECT_ROOT}/dataset/CLEVR_Human/features

ln -s ../../features/valtdiuc_ids_map.json val_ids_map.json
