...
--dictionary_file /mnt/efs/ramen/dataset/${DATA_SET}/features/dictionary.pkl \
--glove_file /mnt/efs/ramen/dataset/${DATA_SET}/features/glove6b_init_300d.npy \
