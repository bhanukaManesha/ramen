...
def train_model():
    ...
    if not args.test:
        train_loader = DataLoader(train_dset, batch_size, shuffle=True, num_workers=16, pin_memory=True)
    else:
        train_loader = None
    eval_loader = DataLoader(val_dset, batch_size, shuffle=False, num_workers=16, pin_memory=True)
